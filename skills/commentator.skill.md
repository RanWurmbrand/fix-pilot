...
| Hints | artifacts/hints/hint_*.json | trace-analyzer | Root cause analysis for each failure |
| Bug fixes | artifacts/bug_fixes/fix_*.json | bug-fixer | Fix suggestions with patches |
| Test logs | artifacts/rootcause_logs/run_*.log | pipeline | Raw test output |
